...
def residual1d_block(
    ...
    h3 = instance_norm_layer(inputs = h2, activation_fn = None, name = name_prefix + 'h2_norm')
    #h2_gates = conv1d_layer(inputs = h1_glu, filters = filters//2 , kernel_size = kernel_size, strides = strides, activation = None, name = name_prefix + 'h2_gates')
    #h2_norm_gates = instance_norm_layer(inputs = h2_gates, activation_fn = None, name = name_prefix + 'h2_norm_gates')
    #h3_1 = gated_linear_layer(inputs = h3, gates = h2_norm_gates, name = name_prefix + 'h2_glu')
...
def generator_gatedcnn(inputs, reuse = False, scope_name = 'generator_gatedcnn'):
    ...
    with tf.variable_scope(scope_name) as scope:
        ...
        # Residual blocks
        r1 = residual1d_block(O,index=0,inputs = d2, filters = 1024, kernel_size = 3, strides = 1, name_prefix = 'residual1d_block1_')
        r2 = residual1d_block(O,index=1,inputs = r1, filters = 1024, kernel_size = 3, strides = 1, name_prefix = 'residual1d_block2_')
        r3 = residual1d_block(O,index=2,inputs = r2, filters = 1024, kernel_size = 3, strides = 1, name_prefix = 'residual1d_block3_')
        r4 = residual1d_block(O,index=3,inputs = r3, filters = 1024, kernel_size = 3, strides = 1, name_prefix = 'residual1d_block4_')
        r5 = residual1d_block(O,index=4,inputs = r4, filters = 1024, kernel_size = 3, strides = 1, name_prefix = 'residual1d_block5_')
        r6 = residual1d_block(O,index=5,inputs = r5, filters = 1024, kernel_size = 3, strides = 1, name_prefix = 'residual1d_block6_')

        # Upsample
        print("r6:::::::::::::::::::::::::::::::::::::::::::::::::::::")
        print(r6)
        #r6[1]=r6[1]/2
        #u1 = upsample1d_block(inputs =r6, filters = 1024, kernel_size = 5, strides = 2, shuffle_size = 2, name_prefix = 'upsample1d_block1_')
        #print("u1:::::::::::::::::::::::::::::::::::::::::::::::::::::")
        #print(u1)
        #u2 = upsample1d_block(inputs =u1, filters = 512, kernel_size = 5, strides = 2, shuffle_size = 2, name_prefix = 'upsample1d_block2_')
        #print("u2:::::::::::::::::::::::::::::::::::::::::::::::::::::")
        #print(u2)
        #u1 = upsample1d_block(inputs = r6+r6, filters = 1024, kernel_size = 5, strides = 1, shuffle_size = 2, name_prefix = 'upsample1d_block1_')
        #u2 = upsample1d_block(inputs = u1+u1, filters = 512, kernel_size = 5, strides = 1, shuffle_size = 2, name_prefix = 'upsample1d_block2_')
        #u1 = downsample1d_block(inputs = r6+d2, filters = 256, kernel_size = 5, strides = 2, name_prefix = 'upsample1d_block1_')
        #print("u1:::::::::::::::::::::::::::::::::::::::::::::::::::::")
        #print(u1)
        #u2 = upsa
        ...
        # Output
        o1 = conv1d_layer(inputs = u1, filters = 24, kernel_size = 15, strides = 1, activation = None, name = 'o1_conv')
